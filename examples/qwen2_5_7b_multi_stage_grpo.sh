...
#   STAGE2_VAL_BEFORE_TRAIN=true STAGE2_DISABLE_EXTRA_VALIDATIONS=1 STAGE2_CODE_REWARD_WORKERS=8 bash examples/qwen2_5_7b_multi_stage_grpo.sh
#   STAGE1_CODE_REWARD_WORKERS=8 STAGE3_CODE_REWARD_WORKERS=8 bash examples/qwen2_5_7b_multi_stage_grpo.sh
...
CHECKPOINT_DIR_ROOT="${CHECKPOINT_DIR_ROOT:-/disk4/yiran/yaoqi/checkpoints/${PROJECT_NAME}}"
...
STAGE1_ACTOR_GLOBAL_BATCH_SIZE="${STAGE1_ACTOR_GLOBAL_BATCH_SIZE:-64}"
STAGE1_ROLLOUT_BATCH_SIZE="${STAGE1_ROLLOUT_BATCH_SIZE:-64}"
...
STAGE1_MAX_RESPONSE_LENGTH="${STAGE1_MAX_RESPONSE_LENGTH:-1536}"
...
STAGE1_CODE_REWARD_WORKERS="${STAGE1_CODE_REWARD_WORKERS:-8}"
STAGE1_CODE_REWARD_MAX_TESTS="${STAGE1_CODE_REWARD_MAX_TESTS:-8}"
...
STAGE2_ACTOR_GLOBAL_BATCH_SIZE="${STAGE2_ACTOR_GLOBAL_BATCH_SIZE:-64}"
STAGE2_ROLLOUT_BATCH_SIZE="${STAGE2_ROLLOUT_BATCH_SIZE:-64}"
...
STAGE2_MAX_RESPONSE_LENGTH="${STAGE2_MAX_RESPONSE_LENGTH:-3072}"
STAGE2_ACTOR_LR="${STAGE2_ACTOR_LR:-1e-6}"
STAGE2_PRIMARY_VAL_LIMIT="${STAGE2_PRIMARY_VAL_LIMIT:-64}"
...
STAGE2_VAL_BEFORE_TRAIN="${STAGE2_VAL_BEFORE_TRAIN:-true}"
STAGE2_VAL_GENERATIONS_TO_LOG="${STAGE2_VAL_GENERATIONS_TO_LOG:-1}"
STAGE2_ROLLOUT_N="${STAGE2_ROLLOUT_N:-4}"
STAGE2_DISABLE_EXTRA_VALIDATIONS="${STAGE2_DISABLE_EXTRA_VALIDATIONS:-0}"
STAGE2_CODE_REWARD_WORKERS="${STAGE2_CODE_REWARD_WORKERS:-8}"
STAGE2_CODE_REWARD_MAX_TESTS="${STAGE2_CODE_REWARD_MAX_TESTS:-8}"

STAGE3_TOTAL_EPOCHS="${STAGE3_TOTAL_EPOCHS:-2}"
STAGE3_MAX_STEPS="${STAGE3_MAX_STEPS:-400}"
...
STAGE3_ACTOR_GLOBAL_BATCH_SIZE="${STAGE3_ACTOR_GLOBAL_BATCH_SIZE:-64}"
STAGE3_ROLLOUT_BATCH_SIZE="${STAGE3_ROLLOUT_BATCH_SIZE:-64}"
STAGE3_VAL_BATCH_SIZE="${STAGE3_VAL_BATCH_SIZE:-64}"
STAGE3_MICRO_BATCH_SIZE_UPDATE="${STAGE3_MICRO_BATCH_SIZE_UPDATE:-8}"
STAGE3_MICRO_BATCH_SIZE_EXPERIENCE="${STAGE3_MICRO_BATCH_SIZE_EXPERIENCE:-8}"
...
STAGE3_CODE_REWARD_WORKERS="${STAGE3_CODE_REWARD_WORKERS:-8}"
STAGE3_CODE_REWARD_MAX_TESTS="${STAGE3_CODE_REWARD_MAX_TESTS:-8}"
...
STAGE_OVERRIDE_KEYS=(
    ...
    ROLLOUT_N
    DISABLE_EXTRA_VALIDATIONS
    CODE_REWARD_WORKERS
    CODE_REWARD_MAX_TESTS
    EXTRA_TRAIN_ARGS
    PRIMARY_VAL_LIMIT
    AIME25_VAL_LIMIT
    MBPP_VAL_LIMIT

...
STAGE1_VAL_FREQ="${STAGE1_VAL_FREQ:-20}"
STAGE1_SAVE_FREQ="${STAGE1_SAVE_FREQ:-20}"
STAGE1_SAVE_LIMIT="${STAGE1_SAVE_LIMIT:-3}"
...
STAGE1_PRIMARY_VAL_LIMIT="${STAGE1_PRIMARY_VAL_LIMIT:-200}"
...
STAGE2_VAL_FREQ="${STAGE2_VAL_FREQ:-20}"
STAGE2_SAVE_FREQ="${STAGE2_SAVE_FREQ:-20}"
STAGE2_SAVE_LIMIT="${STAGE2_SAVE_LIMIT:-3}"
...
STAGE2_PRIMARY_VAL_LIMIT="${STAGE2_PRIMARY_VAL_LIMIT:-32}"
...
GSM8K_TEST_LIMIT="${GSM8K_TEST_LIMIT:-}"
...
if [[ "${PREPARE_DATA}" == "1" ]]; then
    ...
    [[ -n "${GSM8K_TEST_LIMIT}" ]] && PREPARE_ARGS+=("--gsm8k_test_limit" "${GSM8K_TEST_LIMIT}")
